...
class AuthMiddleware(BaseHTTPMiddleware):
    def __init__(self, app, auth_provider: TokenAuthProvider = None):
        super().__init__(app)
        self.auth_provider = auth_provider or TokenAuthProvider.from_env()
    ...
    async def dispatch(
        ...
        if policy is not None:
            ...
            try:
                principal = self.auth_provider.authenticate(token)
